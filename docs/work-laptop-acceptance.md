...
5. Select items and create a review. Save a historical correction that jumps to a valid later state, naming reason, evidence and effective date. Preview and apply. The item should change directly without intermediate open items, retain the dated correction in History and still show missing evidence/links as integrity findings.
