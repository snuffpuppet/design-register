...
Version 2.33, 20 September 2026. Owner: Adam Moyes.
...
| Implemented by | Vendor, Internal or Both. Whose build the item lands in. Required on requirements, decisions and change requests. On a limitation it follows from the chosen option, so it is optional until the limitation is Accepted or Change requested. Not used on risks or open items. |
